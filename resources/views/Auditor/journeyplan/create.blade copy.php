                            ...
                            <div class="row">
                                <div class="clearfix m-b-15 col-md-6 hidden" id="buttonDeleteMultiple">
                                    <div class="pull-left">
                                        ...
                                        {{-- <button type="button" id="storeAuditPlanLookupOutlet" name="storeAuditPlanLookupOutlet" class="btn btn-sm btn-primary waves-effect waves-light">
                                        <i class="fa fa-plus"></i>&nbsp;Delete Selected Outlet
                                    </button> --}}
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="auditPlanLookupModalLabel">Add Outlet modal</h4>
                </div>
            ...
            if (confirm("Remove Selected Outlet?")) {
                ...
                $('.selectedAuditPlanRemove').each(function() {
                    if ($(this).is(':checked', true)) {
                        selected_outlets.push($(this).attr('data-id'))
            ...
            tableAuditPlan = $('#tableAuditPlan').DataTable({
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function(data, type, row, meta) {
                            // return `<input type="hidden" name="outlets[]" value="${row.id}">${row.name}`;
