                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <a class="btn btn-danger m-t-20" href="{{ route('unilever.index') }}">
                                ...
                                @if($canChangeDeliveryDate)
                                    ...
                                    <div id="modal-delivery-date" class="modal-demo">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <form action="{{route('unilever.changeDeliveryDate',['unilever' => $outletProgress->id])}}"
                                ...
                                @endif
                                @if($canReject)
                                    <form action="{{route('unilever.reject',['unilever' => $outletProgress->id])}}"
                                          method="POST" class="pull-right">
                                        @csrf
                                        @method('PUT')
                                        <button name="button-approve" class="btn btn-danger m-t-20" title="approve">
                                            <i class="ion-close"></i>&nbsp;Reject
                                        </button>
                                    </form>
                                @endif
                                @if($canApprove)
                                    <form action="{{route('unilever.approve',['unilever' => $outletProgress->id])}}"
                                          method="POST" class="pull-right">
                                        @csrf
                                        @method('PUT')
