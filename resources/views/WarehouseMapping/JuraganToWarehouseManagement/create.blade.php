        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    {{ Form::hidden('id_juragan_mappings') }}
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <!-- <button type="button" id="btn-save" class="btn waves-effect waves-light btn-rounded btn-sm btn-success"><i class="fa fa-check"></i> Save -->
                                            </button>
