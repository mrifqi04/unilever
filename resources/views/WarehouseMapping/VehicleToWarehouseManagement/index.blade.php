                    ...
                    <div class="card-box">
						...
						<div style="display : flex; justify-content : space-between; align-items : center">
                            <div>
                                ...
                                @if(Auth::user()->getPermissionByName('vehicle_to_warehouse.create'))
                                    <a href="{{route('vehicle_to_warehouse.create')}}">
						...
						<div class="collapse" id="filter_data">
                            <div class="card-box">
                                <div class="card-view">
                                    {{ Form::open(array('url' => route('vehicle_to_warehouse.index'), 'role' => 'form', 'method' => 'get')) }}
                                    <div class="row">
                                    ...
                                    <div class="row m-t-10">
                                        <div class="form-group col-md-12">
                                            ...
                                            <a href="{{route('vehicle_to_warehouse.index')}}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if((Auth::user()->getPermissionByName('vehicle_to_warehouse.edit')))
                                            <a href="{{route('vehicle_to_warehouse.edit', $data->id)}}"
                                               class="btn waves-effect waves-light btn-rounded btn-sm btn-info">
                                                Edit
                                            </a>
                                        @endif
                                        @if(Auth::user()->getPermissionByName('vehicle_to_warehouse.show'))
                                            <a href="{{route('vehicle_to_warehouse.show', $data->id)}}"
                                               class="btn waves-effect waves-light btn-rounded btn-sm btn-default">
                                                Show
                                            </a>
                                        @endif
                                        <br>
                                        @if(Auth::user()->getPermissionByName('vehicle_to_warehouse.delete'))
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open([
                                                                'method' => 'GET',
                                                                'url' => ['/vehicle-to-warehouse/delete', $data->id],
