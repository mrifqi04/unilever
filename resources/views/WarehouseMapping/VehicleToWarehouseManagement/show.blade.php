                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="{{route('vehicle_to_warehouse.index')}}">Juragan to Vehicle</a>
                            </li>
                            <li class="active">
                                Show
                            </li>
                        ...
                        <div class="form-group">
                            {{ Form::label('listAdmin', 'Data Vehicle', array('class' => 'col-2 col-form-label')) }}
                            <div class="col-10">
                                <table class="table table-hover" id="data-table">
                                    ...
                                    <tbody id="listadmin">
                                        @foreach($current_vehicle as $i)
                                            @php
                                                $vehicleData = App\Models\Driver\Vehicles::find($i);
                                            @endphp
                                        <tr>
                                            <td><input type="checkbox" id="val{{$vehicleData->id}}" name="id_submitted_outlets[]" value="{{$vehicleData->id}}" checked onclick="return false;"/>&nbsp;</td>
                                            <td>{{$vehicleData->license_number}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="form-group">
                            <div class="col-10">
                                <a class="btn btn-danger m-t-20" href="{{ route('vehicle_to_warehouse.index') }}"><i
