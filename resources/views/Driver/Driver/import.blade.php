                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="{{ route('driver.import') }}">Upload</a>
                            </li>
                        </ol>
                        ...
                        <a class="btn btn-success d-none d-lg-block"
                            href="{{ asset('assets/templates/driver-template.csv') }}" download>
                            <i class="fa fa-download"></i> Download Template
                        </a>

                        @if (Auth::user()->getPermissionByName('driver.import'))
                            <div class="collapse" id="filter_data">
                                <div class="card-box">
                                    <div class="card-view">
                                        {{ Form::open(['url' => route('driver.import'), 'role' => 'form', 'files' => 'true']) }}

                                        <div class="form-group">
                                            {{ Form::label('import_file', 'File', ['class' => 'col-2 col-form-label']) }}
                                            <div class="col-10">
                                                {{ Form::file('import_file', ['class' => 'filestyle', 'data-iconname' => 'fa fa-cloud-upload']) }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-10">
                                                <button type="submit" id="submit_import_button" class="btn btn-success"><i class="fa fa-check"></i>
                                                    Submit
                                                </button>
                                            </div>
                                        </div>
...
@push('scripts')
    <script src="{{ asset('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js') }}" type="text/javascript">
    </script>
    <!-- Modal-Effect -->
