...
@section('content')
    ...
    <div class="content">
        ...
        <div class="wraper container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    @if($journey_plan_id != '')
                        <div class="btn-group pull-right m-t-15">
                            ...
                            <ul class="dropdown-menu drop-menu-right" role="menu">
                                <li><a href="{{route('delivery.exportPDF')}}?id={{$journey_plan_id}}">ADR / BAP</a></li>
                            </ul>
                        </div>
                    @endif
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{route('route_plan.index')}}">Route Plans Management</a></li>
                            ...
                            <div class="nicescroll p-l-r-10" style="max-height: 555px;">
                                <div class="timeline-2">
                                    @if(count($data->outlet->mapOutlet->outletProgress) > 0)
                                        @foreach($data->outlet->mapOutlet->outletProgress->sortBy("created_at") as $op)
                                            <div class="time-item">
                                                <div class="item-info">
                                                    <div class="text-muted">
                                                        <small>{{\Carbon\Carbon::parse($op->created_at)->format('M d Y H:i:s')}}</small>
                                                    </div>
                                                    <p><span class="text-capitalize font-bold">{{$op->section}}</span>
                                                    </p>
                                                    <p>
                                                        Status
            ...
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-danger m-t-20 pull-right" href="{{ route('route_plan.index') }}"><i
