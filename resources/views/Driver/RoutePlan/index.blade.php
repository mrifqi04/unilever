                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="{{route('route_plan.index')}}">Route Plans Management</a>
                            </li>
                        </ol>
                        ...
                        @if(Auth::user()->getPermissionByName('route_plan.create'))
                            <a href="{{route('route_plan.create')}}">
                        ...
                        @if(Auth::user()->getPermissionByName('route_plan.exportActivity'))
                            ...
                            <div id="modal-export-activity" class="modal-demo">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <form method="get" action="{{route('route_plan.exportActivity')}}" role="form"
						...
						<div class="collapse" id="filter_data">
                            <div class="card-box">
                                <div class="card-view">
                                    {{ Form::open(array('url' => route('route_plan.index'), 'role' => 'form', 'method' => 'get')) }}
                                    <div class="form-group">
                                    ...
                                    @foreach($datas as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ Form::open(array('url' => route('route_plan.destroy', ['route_plan'=>$data->id]))) }}

                                                @if(Auth::user()->getPermissionByName('route_plan.show'))
                                                    <a href="{{route('route_plan.show', ['route_plan'=>$data->id])}}"
                                                ...
                                                @if((Auth::user()->getPermissionByName('route_plan.cancel') && ($data->plan_status != 'canceled')) && ($data->journeyRoute->isEmpty()))
                                                    <a href="{{url('route_plan/cancel', ['route_plan'=>$data->id])}}"
                                                    class="btn waves-effect waves-light btn-rounded btn-sm btn-danger">
                                                        Cancel
                                                    </a>
                                                @endif

                                                @if(Auth::user()->getPermissionByName('route_plan.destroy'))
