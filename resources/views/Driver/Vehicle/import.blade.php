                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="{{ route('vehicle.import') }}">Upload Vehicle</a>
                            </li>
                        </ol>
                        ...
                        <a class="btn btn-success d-none d-lg-block"
                            href="{{ asset('assets/templates/vehicle-template.csv') }}" download>
                            <i class="fa fa-download"></i> Download Template
                        </a>

                        @if (Auth::user()->getPermissionByName('vehicle.import'))
                            <div class="collapse" id="filter_data">
                                <div class="card-box">
                                    <div class="card-view">
                                        {{ Form::open(['url' => route('vehicle.import'), 'role' => 'form', 'files' => 'true']) }}
                                        ...
                                        <div class="form-group">
                                            <div class="col-10">
                                                <button type="submit" id="submit_import_button" class="btn btn-success"><i
                                                        class="fa fa-check"></i>
                                                    Submit</button>
                                            </div>
                                        </div>
