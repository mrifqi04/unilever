                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="{{ route('outlet.import') }}">Upload outlet</a>
                            </li>
                        </ol>
                        ...
                        <a class="btn btn-success d-none d-lg-block"
                            href="{{ asset('assets/templates/outlet-template.csv') }}" download>
                        ...
                        @if (Auth::user()->getPermissionByName('juragan.import'))
                            <div class="collapse" id="filter_data">
                                <div class="card-box">
                                    <div class="card-view">
                                        {{ Form::open(['url' => route('outlet.import'), 'role' => 'form', 'files' => 'true']) }}

                                        <div class="form-group">
                                            {{ Form::label('outlet_import_file', 'File', ['class' => 'col-2 col-form-label']) }}
                                            <div class="col-10">
                                                {{ Form::file('outlet_import_file') }}
                                            </div>
                                        </div>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <button type="button" data-toggle="modal"
                                                    data-target="#modal-error-{{ $data->id }}"
