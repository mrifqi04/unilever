            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        {{ Html::ul($errors->all()) }}
                        {{ Form::open(array('url' => route('journeyplan.store'), 'role' => 'form')) }}
                        <div class="form-group">
                            {{ Form::label('id', 'ID', array('class' => 'col-2 col-form-label')) }}
                            <div class="col-10">
                                {{ Form::text('id', old('id'), array('class' => 'form-control', 'placeholder'=>'ID', 'required'=>'required')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('id_juragan', $juragans, old('id_juragan'), ['placeholder' => 'Pilih Juragan', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('assign_to', $hunters, old('assign_to'), ['placeholder' => 'Pilih Hunter', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
