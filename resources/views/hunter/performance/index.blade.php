...
@section('content')
    <div class="content">
        <div class="container">
            <form action="{{route('performance.index')}}" role="form" autocomplete="off">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="portlet">
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#summary_from_date,#summary_to_date,#performance_from_date,#performance_to_date").datepicker({"format": "yyyy-mm-dd"});
        })
    </script>
@endpush
