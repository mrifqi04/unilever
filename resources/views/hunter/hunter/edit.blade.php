            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        {{ Html::ul($errors->all()) }}
                        {{ Form::model($hunter, array('route' => array('hunter.update', $hunter->id), 'method' => 'PUT', 'role'=>'form')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::text('phone', old('phone', $hunter->phone), array('class' => 'form-control', 'placeholder'=>'Phone', 'required'=>'required')) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::text('longitude', old('longitude', $hunter->longitude), ['class' => 'form-control', 'placeholder'=>'Longitude', 'required'=>'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
