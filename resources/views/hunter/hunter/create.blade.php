            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        {{ Html::ul($errors->all()) }}
                        {{ Form::open(array('url' => route('hunter.store'), 'role' => 'form')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::text('phone', old('phone'), array('class' => 'form-control', 'placeholder'=>'Phone', 'required'=>'required')) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('id_district', $districts, old('id_district'), ['placeholder' => 'Pilih District', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Pilih salah satu, tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('id_village', $villages, old('id_village'), ['placeholder' => 'Pilih Village', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Pilih salah satu, tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::textarea('address', old('address'), array('rows' =>5, 'class' => 'form-control', 'placeholder'=>'Address', 'required'=>'required')) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::text('latitude', old('latitude'), array('class' => 'form-control', 'placeholder'=>'Latitude', 'required'=>'required')) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::text('longitude', old('longitude'), ['class' => 'form-control', 'placeholder'=>'Longitude', 'required'=>'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('id_user_types', $user_types, old('id_user_types'), ['placeholder' => 'Pilih User Type', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Pilih salah satu, tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                {{ Form::select('status_active', $actives, old('status_active'), ['placeholder' => 'Pilih Active', 'class' => 'form-control', 'required' => 'required']) }}
                                <small class="form-text text-muted">
                                    <span class="text-danger">*</span> Pilih salah satu, tidak boleh dikosongkan.
                                </small>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-10">
                                ...
                                <a class="btn btn-danger m-t-20" href="{{ route('hunter.index') }}"><i
