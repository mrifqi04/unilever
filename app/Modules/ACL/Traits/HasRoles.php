...
use App\Modules\ACL\Contract\Permission;
use App\Modules\ACL\Contract\Role;
...
trait HasRoles {
    ...
    public function roles() {
        return $this->belongsToMany(
            'App\Models\UserManagement\Role', 'public.user_has_roles'
        );
    }
    ...
    public function permissions() {
        return $this->belongsToMany(
            'App\Models\UserManagement\Permission', 'public.role_has_permissions'
        );
    }
    ...
    /**
     * Return all the service the user has via roles.
     *
     * @return bool
     */
    public function getPermissionByName($name) {
        $services = $this->getPermissionsViaRoles();
