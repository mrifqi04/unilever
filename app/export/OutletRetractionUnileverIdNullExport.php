...
class OutletRetractionUnileverIdNullExport implements WithHeadings, WithMapping, FromCollection
{
    private $collection = [];

    /**
     * OutletRetractionUnileverIdNullExport constructor.
     */
        ...
        $sql = '
          SELECT 
            ...
            (
              SELECT 
                op.created_date
              FROM outlet.outlet_retraction_progress AS op
