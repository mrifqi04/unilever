 ...
 * @method static OutletProgress find(string $id)
 */
class OutletProgress extends Model
{
    ...
    {
        return $this->status_progress === '3' && $this->section === 'juragan' && $this->status_active === 1;
    }
     ...
     * @return bool
     */
    public function canChangeDeliveryDate()
    {
        return $this->status_progress === '3' && $this->section === 'juragan' && $this->status_active === 1;
    }
...
//    public static function getPictureIds(?string $id_answer): Collection
    public static function getPictureIds($answer): Collection
    {
//        $record = DB::table('hunter.answers')
//            ->where('id', '=', $id_answer)
//            ->first();
